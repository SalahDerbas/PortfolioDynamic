    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          <img src="{{ URL::asset('attachments/logo/'.$about['logo']) }}" class="img-fluid animated" >
        </div>
      </div>
    </div>
    ...
    <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        @foreach ($pricings as $pricing)
          ...
          <div class="member col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay=" <?php $i=$i+100 ?>">
            <div class="box">
    ...
    <section id="faq" class="faq section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="faq-list">
          ...
          <span class="disable-links" >
            <li data-aos="fade-up" data-aos-delay="<?php $i=$i+100; ?>" style="margin-top:20px;">

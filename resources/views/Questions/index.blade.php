                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> Question Informations</h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table id="datatable"  class="table table-bordered table-striped">
                                ...
                                @foreach ($question as $questi)
                                    <tr>
                                        <?php $i++; ?>
                                        <td>{{ $i }}</td>
                                        <td>{{$questi->question}}</td>
                                        <td>{{$questi->answer}}</td>
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#edit{{$questi->id}}"
                                                    title=""><i class="fa fa-edit"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#delete{{$questi->id}}"
                                                    title=""><i
                                    ...
                                    <!-- edit_modal_Grade -->
                                    <div class="modal fade" id="edit{{$questi->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <!-- delete_modal_Grade -->
                                    <div class="modal fade" id="delete{{ $questi->id }}" tabindex="-1" role="dialog"
                                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">

                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Positions Informations</h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table id="datatable"  class="table table-bordered table-striped">
                                ...
                                @foreach ($Positions as $Position)
                                    <tr>
                                        ...
                                        <td>{{$Position->title_skill}}</td>
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#edit{{$Position->id}}"
                                                    title=""><i class="fa fa-edit"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#delete{{$Position->id}}"
                                                    title=""><i
                                                    ...
                                                    <form action="{{ route('Position.update', 'test') }}" method="post">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <label for="position_skill"
                                                                       class="mr-sm-2">Name Position
                                                                    :</label>
                                                                <input id="name_position" type="text" name="name_position"
                                                                       class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="title_skill"
                                                                      ...
                                                                      rows="3">{{$Position->title_skill}}</textarea>
                                                        </div>
                                                        <br><br>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('Position.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="Name" class="mr-sm-2">Name Position
                                        :</label>
                                    <input id="name_position" type="text" name="name_position" class="form-control">
                                </div>

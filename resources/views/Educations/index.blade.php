                        ...
                        <div class="card-body">
                            <table id="datatable"  class="table table-bordered table-striped">
                                ...
                                @foreach ($Educations as $Education)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                    data-target="#edit{{$Education->id}}"
                                                    title=""><i class="fa fa-edit"></i></button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                    data-target="#delete{{$Education->id}}"
                                                    title=""><i
                                    ...
                                    <div class="modal fade" id="edit{{$Education->id}}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="row">
                                                            <div class="col">
                                                                <label for="from_education"
                                                                       class="mr-sm-2">From Date
                                                                    :</label>
                                                                <input type="date" class="form-control"
                                                                       value="{{$Education->from_education}}"
                                                                       name="from_education" required>
                                                            </div>
                                                    <div class="col">
                                                        <label for="to_education"
                                                               class="mr-sm-2">To Date
                                                            :</label>
                                                        <input type="date" class="form-control"
                                                               value="{{$Education->to_education}}"
                                                               name="to_education" required>
                                                    </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <label for="univercity_name"
                                                               class="mr-sm-2">University Name
                                                            :</label>
                                                        <input id="univercity_name" type="text" name="univercity_name"
                                                               class="form-control"
                                                               value="{{$Education->univercity_name}}"
                                                               required>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="title"
                                                                      ...
                                                                      rows="3">{{$Education->title}}</textarea>
                                                        </div>
                                                        <br><br>
                                    ...
                                    <!-- delete_modal_Grade -->
                                    <div class="modal fade" id="delete{{ $Education->id }}" tabindex="-1" role="dialog"
                                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('Educations.destroy', 'test') }}" method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
                                                        Are you sure delete ?
                                                        <input id="id" type="hidden" name="id" class="form-control"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('Educations.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="Name" class="mr-sm-2">Education Name
                                        :</label>
                            ...
                            <div class="row">
                                <div class="col">
                                    <label for="Name_en" class="mr-sm-2">From Date
                                        :</label>
                                    <input id="from_education" type="date" class="form-control" name="from_education">
                                </div>
                                <div class="col">
                                    <label for="Name_en" class="mr-sm-2">To Date
                                        :</label>
                                    <input id="to_education" type="date" class="form-control" name="to_education">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label for="Name" class="mr-sm-2">University Name
                                        :</label>
                                    <input id="univercity_name" type="text" name="univercity_name" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">

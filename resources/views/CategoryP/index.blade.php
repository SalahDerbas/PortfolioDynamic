                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <!-- add_form -->
                                                    <form action="{{ route('CategoryP.update', 'test') }}" method="post">
                                                        {{ method_field('put') }}
                                                        @csrf
                                                        <div class="row">
                                                            <div class="col">
                                                                <label for="position_skill"
                                                                       class="mr-sm-2">Name Category
                                                                    :</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                ...
                                                                :</label>
                                                            <textarea class="form-control" name="title_category"
                                                                      id="exampleFormControlTextarea1"
                                                                      rows="3">{{$Category->title_category}}</textarea>
                                                        </div>
                                                        <br><br>
                                    ...
                                    <div class="modal fade" id="delete{{ $Category->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('CategoryP.destroy', 'test') }}" method="post">
                                                        {{ method_field('Delete') }}
                                                        @csrf
                                                        Are you sure delete ?
                                                        <input id="id" type="hidden" name="id" class="form-control"
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- add_form -->
                        <form action="{{ route('CategoryP.store') }}"  method="POST">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <label for="Name" class="mr-sm-2">Name Category
                                        :</label>
                                    <input id="name_category" type="text" name="name_category" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Title
                                    :</label>
                                <textarea class="form-control" name="title_category" id="exampleFormControlTextarea1"
                                          rows="3"></textarea>
                            </div>
